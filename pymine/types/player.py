...
class Player:
    def __init__(self, *, data_version: int, player_game_type: int, prev_player_game_type: int, score: int, dimension: str, selected_item_slot: int, selected_item: nbt.TAG_Compound, spawn_dimension: str, spawn_x: int, spawn_y: int, spawn_forced: bool, sleep_timer: int, food_level: int, food_exhaustion_level: float, food_saturation_level: float, food_tick_timer: int, xp_level: int, xp_percent: float, xp_total: int, xp_seed: int, inventory: nbt.TAG_List, ender_chest: nbt.TAG_List, abilities: nbt.TAG_Compound, entered_nether_position: nbt.TAG_Compound, root_vehicle: nbt.TAG_Compound, shoulder_entity_left: nbt.TAG_Compound, shoulder_entity_right: nbt.TAG_Compound, seen_credits: bool, recipe_book: nbt.TAG_Compound) -> None:
        pass
