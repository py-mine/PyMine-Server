...
class LevelData:  # https://minecraft.gamepedia.com/Java_Edition_level_format#level.dat_format
    def __init__(self, allow_commands: bool, border_center_x: float, border_center_z: float, border_damage_per_block: float, border_size: float, border_safe_zone: float, border_size_lerp_target: float, border_size_lerp_time: int, border_warning_blocks: float, border_warning_time: float, clear_weather_time: int, custom_boss_events: nbt.TAG_Compound, datapacks: nbt.TAG_Compound, data_version: int, day_time: int, difficulty: int, difficulty_locked: bool, dimension_data: nbt.TAG_Compound, gamerules: nbt.TAG_Compound, world_gen_settings: nbt.TAG_Compound, game_type: int, generator_name: str, generator_options: nbt.TAG_Compound, generator_version: int, hardcore: bool, initialized: bool, last_played: int, level_name: str, map_features: bool, player: nbt.TAG_Compound, raining: bool, rain_time: int, random_seed: int, size_on_disk: int, spawn_x: int, spawn_y: int, spawn_z: int, thundering: bool, thunder_time: int, time: int, version: int, version_data: nbt.TAG_Compound, wandering_trader_id: list, wandering_trader_spawn_chance: int, wandering_trader_spawn_delay: int) -> None:
        pass
